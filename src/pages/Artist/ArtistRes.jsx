...
export default function ArtistRes({arParam,headerBackground}) {
    ...
    useEffect(()=>{
        const getres=async ()=>{
            ...
            const response=await axios.get(`http://127.0.0.1:5000/artist`,{
                headers: {
                    Authorization: "Bearer " + token,
                    "Content-Type": "application/json",
                    "Artist-Param": arParam
                },
            })
        ...
        <>
          <div className="playlist">
            ...
            <div className="details">
              ...
              {/* <p className="description">{Lis.ml}</p> */}
            </div>
          </div>
          <h1>SONGS</h1>
