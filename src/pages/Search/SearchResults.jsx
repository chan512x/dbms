...
export default function SearchResults( { searchParam ,headerBackground}) {
...
const addtoplay=async (play_id,id,index)=>{
  const token = localStorage.getItem('token');
                    ...
                    >
                      ...
                      {showMenu[index] && (
                                        <PlaylistsBox>
                                            ...
                                            <li key={play_id} onClick={()=>addtoplay(play_id,id,index)}>{play_name}</li>
                                            ))}
                                            </ul>
                                        </PlaylistsBox>
                                    )}
